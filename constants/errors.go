...
const (
	...
	ErrorFreezingTenantAccountRequest           = "failed request to freeze tenant account"
	ErrorUnfreezingTenantAccountRequest         = "failed request to unfreeze tenant account"
