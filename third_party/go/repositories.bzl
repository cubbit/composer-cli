...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:QEvenaO+Y9ShPeCWsSAtolzVUcb0T0tPeek5TDsovuM=",
        version = "v67.3.0+incompatible",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:UoAcbQ6Qml8hDwSWs0Y1cB5TEQuZkDPH/ZqwWWYTG4g=",
        version = "v0.11.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:TY6CGE6+6hzO7hhJFte65ud3cFmmZW947jajXkuDfBw=",
        version = "v0.12.0",
    )
    go_repository(
