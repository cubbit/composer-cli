...
func main() {
	// --- Mock config (implements ConfigInterface) ---
...
type trivialAgentService struct{}

func (s *trivialAgentService) CreateAgent(c *cobra.Command, a []string) error      { return nil }
func (s *trivialAgentService) CreateAgentBatch(c *cobra.Command, a []string) error { return nil }
func (s *trivialAgentService) DescribeAgent(c *cobra.Command, a []string) error    { return nil }
func (s *trivialAgentService) EditAgent(c *cobra.Command, a []string) error        { return nil }
func (s *trivialAgentService) ListAgents(c *cobra.Command, a []string) error       { return nil }
func (s *trivialAgentService) RemoveAgent(c *cobra.Command, a []string) error      { return nil }
func (s *trivialAgentService) CheckAgentStatus(c *cobra.Command, a []string) error { return nil }
