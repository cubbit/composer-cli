...
func CreateOperatorInteractive(cmd *cobra.Command) error {
	...
	if _, err = tui.TextInputs(
		...
		tui.Input{Placeholder: "Last Name*", IsPassword: false, Value: &lastName}, tui.Input{Placeholder: "Email*", IsPassword: false, Value: &email},
		tui.Input{Placeholder: "Password*", IsPassword: true, Value: &password}, tui.Input{Placeholder: "Secret", IsPassword: true, Value: &secret}); err != nil {
