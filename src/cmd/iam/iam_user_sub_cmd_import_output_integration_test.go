...
func TestIAMUserSubCmd_Import_Output_JSON(t *testing.T) {
...
func TestIAMUserSubCmd_Import_Output_YAML(t *testing.T) {
	email := "alice@example.com"
	usersFile := writeIAMUsersIntegrationFile(t, `{"users":[{"username":"alice","password":"test-password","email":"alice@example.com"},{"username":"bob","password":"test-password"}]}`)
...
func TestIAMUserSubCmd_Import_Output_JSON_FromProfile(t *testing.T) {
	email := "alice@example.com"
	usersFile := writeIAMUsersIntegrationFile(t, `{"users":[{"username":"alice","password":"test-password","email":"alice@example.com"},{"username":"bob","password":"test-password"}]}`)
...
func TestIAMUserSubCmd_Import_Output_YAML_FromProfile(t *testing.T) {
	email := "alice@example.com"
	usersFile := writeIAMUsersIntegrationFile(t, `{"users":[{"username":"alice","password":"test-password","email":"alice@example.com"},{"username":"bob","password":"test-password"}]}`)
