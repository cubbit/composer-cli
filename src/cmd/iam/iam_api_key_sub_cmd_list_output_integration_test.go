...
func TestIAMAPIKeySubCmd_List_Output_JSON(t *testing.T) {
...
func TestIAMAPIKeySubCmd_List_Output_YAML(t *testing.T) {
	frozen := time.Date(2026, 6, 24, 20, 24, 13, 0, time.UTC)
	organizationName := "test-org"
	mockUserAPI := &api.MockUserAPI{
		GetIAMUserSelfFunc: func(_ configuration_models.EndpointsV2, _ string, apiKey string) (*api.IAMUser, error) {
...
func TestIAMAPIKeySubCmd_List_Output_JSON_FromProfile(t *testing.T) {
	frozen := time.Date(2026, 6, 24, 20, 24, 13, 0, time.UTC)
	organizationName := "test-org"
	mockUserAPI := &api.MockUserAPI{
		GetIAMUserSelfFunc: func(_ configuration_models.EndpointsV2, _ string, apiKey string) (*api.IAMUser, error) {
...
func TestIAMAPIKeySubCmd_List_Output_YAML_FromProfile(t *testing.T) {
	frozen := time.Date(2026, 6, 24, 20, 24, 13, 0, time.UTC)
	organizationName := "test-org"
	mockUserAPI := &api.MockUserAPI{
		GetIAMUserSelfFunc: func(_ configuration_models.EndpointsV2, _ string, apiKey string) (*api.IAMUser, error) {
