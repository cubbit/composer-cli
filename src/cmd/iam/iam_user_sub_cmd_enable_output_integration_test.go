...
func TestIAMUserSubCmd_Enable_Output_JSON(t *testing.T) {
...
func TestIAMUserSubCmd_Enable_Output_YAML(t *testing.T) {
	frozen := time.Date(2026, 6, 24, 20, 24, 13, 0, time.UTC)
	orgID := "test-org-id"
	organizationName := "test-org"
...
func TestIAMUserSubCmd_Enable_Output_JSON_FromProfile(t *testing.T) {
	frozen := time.Date(2026, 6, 24, 20, 24, 13, 0, time.UTC)
	orgID := "test-org-id"
	organizationName := "test-org"
...
func TestIAMUserSubCmd_Enable_Output_YAML_FromProfile(t *testing.T) {
	frozen := time.Date(2026, 6, 24, 20, 24, 13, 0, time.UTC)
	orgID := "test-org-id"
	organizationName := "test-org"
