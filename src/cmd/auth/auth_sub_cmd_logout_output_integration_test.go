...
func TestAuthSubCmd_Logout_Output_JSON(t *testing.T) {
...
func TestAuthSubCmd_Logout_Output_YAML(t *testing.T) {
	mockCfg := newTestAuthConfig()
...
func TestAuthSubCmd_Logout_Output_JSON_FromProfile(t *testing.T) {
	mockCfg := newTestAuthConfig()
...
func TestAuthSubCmd_Logout_Output_YAML_FromProfile(t *testing.T) {
	mockCfg := newTestAuthConfig()
