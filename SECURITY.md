...
**Email:** [security@cubbit.io](mailto:security@cubbit.io)

### Disclosure Process

1. **Initial Report**: Send an email to [security@cubbit.io](mailto:security@cubbit.io) with:
...
Security updates are released as patch versions and are marked with the `[SECURITY]` tag in our [CHANGELOG.md](CHANGELOG.md).

### Contact Information

- **Security Issues**: [security@cubbit.io](mailto:security@cubbit.io)
- **General Support**: [GitHub Issues](https://github.com/cubbit/composer-cli/issues)
